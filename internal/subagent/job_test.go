...
// deadReapedPID starts and waits for /bin/true, returning its now-dead-and-reaped
// pid (kill(pid,0) == ESRCH). Used to synthesize a "finished" background job
// without the zombie a Released-but-unwaited child would become in-test.
